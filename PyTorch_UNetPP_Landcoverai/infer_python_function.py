...
geoInfer(image_in="C:/Maxwell_Data/landcover/test_image.tif", pred_out="C:/Maxwell_Data/landcover/predictions/test.tif", chip_size=512, stride_x=256, stride_y=256, crop=70, n_channels=3)
