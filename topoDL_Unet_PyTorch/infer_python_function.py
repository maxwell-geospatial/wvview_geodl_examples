...
val_set = pd.read_csv("C:/Maxwell_Data/topo_work/val_topos.csv")

topo_count = range(0, len(val_set)-1)
for i in topo_count:
    geoInfer(image_in=val_set.iloc[i, 3], 
    pred_out="C:/Maxwell_Data/topo_work/data/predictions/" + str(val_set.iloc[i, 1]), 
